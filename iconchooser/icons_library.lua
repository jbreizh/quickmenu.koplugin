...
local LibraryModal = require("iconchooser/library_modal")
local Notification = require("ui/widget/notification")
local Size = require("ui/size")
local UIManager = require("ui/uimanager")
local VerticalGroup = require("ui/widget/verticalgroup")
local VerticalSpan = require("ui/widget/verticalspan")
local Catalogue = require("iconchooser/icons_catalogue")
...
local function loadNerdFontNames()
    if nerdfont_names == nil then
        nerdfont_names = require("iconchooser/nerdfont_names") or {}
    end
