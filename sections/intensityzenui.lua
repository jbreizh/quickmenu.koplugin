...
function IntensityZenUI.build(ctx)
    ...
    local fl_drag_prefix = TextWidget:new{ text = fl_prefix_text, face = medium_font, bold = true }
    local fl_drag_prefix_w = fl_drag_prefix:getSize().w
    local fl_drag_num = TextWidget:new{ text = tostring(fl.cur), face = medium_font, bold = true }
